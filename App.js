          ...
          <View style={styles.body}>
            ...
            <View style={styles.sectionContainer}>
              <Text style={styles.sectionDescription}>
                ...
                vegetarian salad bowls. Pasta, potato salad and olive fried rice
            ...
            <View style={styles.sectionContainer}>
              <Text style={styles.sectionDescription}>
                <Text style={styles.highlight}>Ayam Penyet</Text> has a long
                queue for its 'smashed chicken'(ayam penyet). The chicken is
                soaked in homemade sauce and topped with crunchy fried crumbs.
                Its chilli is not too spicy.
              </Text>
              <Text style={styles.highlight}>W4/W6 Lawn Canteen</Text>
            </View>
          </View>
